    ...
    <div className="pt-20 pb-4 max-md:pt-10">
      <section className="mx-auto mb-20 max-w-[700px] text-center max-md:mb-12">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <Link to="/register"><Button size="lg" className="px-8 py-3 text-base">{t('hero.getStarted')}</Button></Link>
      ...
      <section className="grid grid-cols-1 gap-6 sm:grid-cols-2 mb-20 max-md:mb-12">
        {FEATURES.map((f) => (
          <div key={f.key} className="rounded-xl border border-border bg-card p-6 text-left">
