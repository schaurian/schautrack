    ...
    <header className="relative z-50">
      <div className="mx-auto flex max-w-[1100px] items-center justify-between px-4 py-3">
        <Link to={user ? '/dashboard' : '/'} className="flex items-center gap-2 text-foreground no-underline">
          <div className="size-11 rounded-xl overflow-hidden grid place-items-center shrink-0">
            <img src="/logo-128.webp" alt="" width={44} height={44} decoding="async" className="w-full h-full object-cover block" />
          </div>
